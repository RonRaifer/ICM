...
public enum MsgEnum implements Serializable {
	...
	CHECK_REVIEW_EXIST, SET_REVIEW_EXIST,ADD_REVIEW, REVIEW_LEADER_APPROVE, APPOINT_STAGE_CHARGE,CHECK_TIME_SET,
	SET_FLAG_TIMEC, ADD_TIME_REQ,CHECK_EXTEND, SET_EXTEND_PROCESSES,INSERT_EXTEND;
}
